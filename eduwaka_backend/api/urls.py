...
from .views import InstitutionViewSet, CourseViewSet, UserProfileViewSet, EligibilityCheckAPIView, ChatbotAPIView, UserListViewSet, DeleteUserViewSet, UserUpdateViewSet, ChangePasswordViewSet, ForgotPasswordViewSet, ResetPasswordViewSet, LoginViewSet
